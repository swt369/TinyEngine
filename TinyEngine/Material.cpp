...
const glm::vec3 Material::DEFAULT_AMBIENT = glm::vec3(0.1f, 0.1f, 0.1f);
const glm::vec3 Material::DEFAULT_DIFFUSE = glm::vec3(0.5f, 0.5f, 0.5f);
const glm::vec3 Material::DEFAULT_SPECULAR = glm::vec3(1.0f, 1.0f, 1.0f);
